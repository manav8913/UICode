...
typedef enum {
			...
			CON_RX_COMMAND_DIALYSIS_BYPASS,
			CON_RX_COMMAND_DIALYSIS_VPT_APT_DEFAULT_ALARM_WINDOW,
...
typedef enum{
			...
			CON_TX_COMMAND_DLSIS_BYPASS, //0x41 65
			CON_TX_COMMAND_COMMAND_HEATER_STATE, //0X42 66
			CON_TX_COMMAND_COMMAND_SYSTEM_STATE, //0X43 67
			CON_TX_COMMAND_COMMAND_SUBSYSTEM_STATE, //0X44 68
