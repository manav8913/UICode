...
typedef enum{
			...
			CON_TX_COMMAND_SYS_DUMMY_44,
			CON_TX_COMMAND_DIALYSATE_FILLING_STOPPED, //45
			CON_TX_COMMAND_SYS_DUMMY_46,
			CONT_TX_COMMAND_SYS_RCIRC_STARTED,//47
			CONT_TX_COMMAND_SYS_RCIRC_STOPPED,//48
			CONT_TX_COMMAND_SYS_RCIRC_COMPLETED,//49
			CONT_TX_COMMAND_SYS_RET_STARTED,//50
			CONT_TX_COMMAND_SYS_RET_STOPPED,//51
			CONT_TX_COMMAND_SYS_RET_COMPLETED,//52
			CONT_TX_COMMAND_BLOODPUMP_ON,//53
			CONT_TX_COMMAND_BLOODPUMP_OFF,//54
			
			CON_TX_COMMAND_COMMAND_SCRIPT_PRNIT,
			CON_TX_COMMAND_COMMAND_IIC_HANGUP,
			CON_TX_COMMAND_COMMAND_SCRIPT_BULK_PRINT,
