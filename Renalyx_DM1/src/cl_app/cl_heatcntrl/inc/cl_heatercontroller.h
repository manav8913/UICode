...
typedef enum
{
	CL_DISTRIB_HEATER_SUBSTATE_OFF,
	CL_DISTRIB_HEATER_SUBSTATE_IDLE,
	CL_DISTRIB_HEATER_SUBSTATE_FIRST_PEAK,
	CL_DISTRIB_HEATER_SUBSTATE_FIRST_DIP,
	CL_DISTRIB_HEATER_SUBSTATE_SECOND_PEAK,
	CL_DISTRIB_HEATER_SUBSTATE_SECOND_DIP,
	CL_DISTRIB_HEATER_SUBSTATE_THIRD_PEAK,
	CL_DISTRIB_HEATER_SUBSTATE_COMPLETED,
	CL_DISTRIB_HEATER_SUBSTATE_MAX
	
	
}HeaterDistributionSubStateType;
typedef enum
{
